# Generated by Django 5.0.4 on 2024-11-13 23:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('curvatura', models.IntegerField(default=1, validators=[django.core.validators.MinValueValidator(1)], verbose_name='Curvatura de análisis')),
                ('cliente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.cliente')),
                ('elemento', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='elemento', to='api.elementos')),
            ],
        ),
        migrations.CreateModel(
            name='Estandar',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('MetodoAnalisis', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Metodo_de_Analisis', to='api.metodoanalisis')),
                ('MuestraMasificada', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='MuestraMasificada', to='api.muestramasificada')),
            ],
        ),
        migrations.CreateModel(
            name='Muestra',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ID_HDT', models.CharField(max_length=200, verbose_name='Nro de Lote')),
                ('muestra', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='muestra_de_analisis', to='api.muestra')),
            ],
        ),
        migrations.CreateModel(
            name='ODT',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('HojaTrabajo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='hojas_trabajo_target', to='api.odt')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('elemento', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='resultados', to='api.elementos')),
                ('hoja_trabajo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='resultados', to='api.hojatrabajo')),
                ('muestra', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='resultados', to='api.muestramasificada')),
            ],
        ),
